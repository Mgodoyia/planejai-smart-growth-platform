      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col items-center text-center md:items-start md:text-left">
            <div className="mb-4 sm:mb-6 md:mb-8 transform scale-110 sm:scale-125 md:scale-150 origin-center md:origin-left">
              <Logo className="w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32" />
            </div>
            <p className="text-gray-400 mb-4 sm:mb-6 max-w-md text-sm sm:text-base md:text-lg">
          ...
          <div className="text-center md:text-left">
            <h4 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-white">Navegação</h4>
            <ul className="space-y-2 text-gray-400 text-sm sm:text-base">
              <li>
                <button 
                  onClick={() => scrollToSection('features')} 
                  className="hover:text-white transition-colors w-full py-1 px-2 rounded hover:bg-white/5"
                >
                  Funcionalidades
                </button>
              </li>
          ...
          <div className="text-center md:text-left">
            <h4 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-white">Contato</h4>
            <ul className="space-y-2 text-gray-400 text-sm sm:text-base">
              <li>
                <a href="#" className="hover:text-white transition-colors block py-1 px-2 rounded hover:bg-white/5">
                  Sobre
                </a>
              </li>
              <li>
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="hover:text-white transition-colors block py-1 px-2 rounded hover:bg-white/5"
                >
                  Instagram
                </a>
              </li>
        ...
        <div className="border-t border-gray-800 mt-6 sm:mt-8 md:mt-12 pt-4 sm:pt-6 md:pt-8 text-center text-gray-400 text-xs sm:text-sm">
          <p>
