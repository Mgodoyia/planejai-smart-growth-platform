...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-48 h-48 bg-gradient-to-br from-indigo-500/10 to-blue-500/10 rounded-full blur-xl animate-pulse delay-700"></div>
      
      {/* Header */}
      <header className="container mx-auto px-6 pt-8 relative z-10">
        <nav className="flex items-center justify-between">
          <Logo className="scale-150 hover:scale-160 transition-transform duration-300" />
      ...
      <div className="container mx-auto px-6 pt-16 pb-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="lg:pr-12">
            {/* Enhanced Badge */}
            <Badge className="mb-8 bg-gradient-to-r from-blue-500/20 to-purple-500/20 text-blue-200 border border-blue-400/30 hover:bg-gradient-to-r hover:from-blue-500/30 hover:to-purple-500/30 transition-all duration-500 backdrop-blur-sm px-6 py-2 text-sm font-medium">
              <div className="w-4 h-4 mr-3 bg-gradient-to-br from-blue-400 to-purple-400 rounded-full animate-pulse"></div>
              Inteligência Artificial para Móveis Planejados
            </Badge>
            
            {/* Enhanced Main Headline */}
            <h1 className="text-6xl md:text-7xl font-bold mb-6 text-white leading-tight animate-fadeIn">
            ...
            {/* Enhanced Subtitle */}
            <h2 className="text-3xl md:text-4xl font-semibold text-blue-200 mb-8 animate-slideUp">
              para lojas de móveis planejados
            </h2>
            
            {/* Enhanced Subheadline */}
            <p className="text-xl md:text-2xl text-blue-100 mb-10 leading-relaxed animate-slideUp delay-200">
            ...
            <div className="flex flex-col sm:flex-row gap-6 mb-12 animate-slideUp delay-300">
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 px-10 py-4 text-lg rounded-xl shadow-2xl hover:shadow-blue-500/25 transform hover:scale-105 transition-all duration-300 group"
            ...
            <div className="text-blue-200 text-sm animate-slideUp delay-400">
              <p className="mb-6 text-lg font-medium text-blue-100">Revolucionando a gestão de móveis planejados no Brasil</p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="flex items-center space-x-2 bg-white/5 backdrop-blur-sm rounded-lg p-3 border border-white/10">
                  <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                  <span className="font-semibold text-green-300">Implementação em 30 dias</span>
                </div>
                <div className="flex items-center space-x-2 bg-white/5 backdrop-blur-sm rounded-lg p-3 border border-white/10">
                  <div className="w-2 h-2 bg-blue-400 rounded-full animate-pulse delay-200"></div>
                  <span className="font-semibold text-blue-300">90 dias de acompanhamento</span>
                </div>
                <div className="flex items-center space-x-2 bg-white/5 backdrop-blur-sm rounded-lg p-3 border border-white/10">
                  <div className="w-2 h-2 bg-purple-400 rounded-full animate-pulse delay-400"></div>
                  <span className="font-semibold text-purple-300">Suporte especializado</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative animate-slideUp delay-500">
            ...
            <Card className="relative bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl rounded-2xl overflow-hidden hover:scale-105 transition-all duration-500">
              <CardContent className="p-0">
                <div className="flex items-center justify-between p-6 border-b border-white/20 bg-gradient-to-r from-white/5 to-transparent">
                  ...
                  <div className="text-sm text-blue-200 font-medium bg-white/10 px-3 py-1 rounded-full">
                    Tela de Login Planej.AI
                  </div>
                </div>
